  ...
  try {
    ...
    switch (type) {
      case "payment_intent.payment_failed": {
        ...
        const msg =
          `🔔  Webhook received! Payment for PaymentIntent ${paymentIntent.id} failed.`;
      ...
      case "source.chargeable": {
        ...
        const msg =
          `🔔  Webhook received! The source ${source.id} is chargeable.`;
    ...
    console.log(error);
    await slackSendMsg(
      `Failed to process Stripe event! Type:${type} Data:${
