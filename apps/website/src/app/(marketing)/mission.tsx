export default function MissionSection() {
  return (
    <section id="ourMission" className="our-mission diagonal">
      <div className="content-container container">
        <div className="landing-section-title light">Our Mission</div>
        <p>
          The Vancouver 8 Hour Relay, organized by Ultra Mileage Running
          Society, aims to unite runners from diverse cities, fostering focused
